...
<div class="container-fluid">
    <div class="row welcome">
        <div class="col-md-10 py-2">
            <h1 class="displayFont"><?php echo $config['title']; ?></h1>
                ...
                <div class="row">
                    <div class="d-flex col-md-2">
                        <?php if (!isset($post['picture'])): ?>
                            <img src="app/imgs/site/avatar_placeholder.png" class="img-thumbnail rounded-circle avatarSmall align-self-center">
                        <?php else : ?>
                            <img src="app/imgs/avatar/<?php echo $post['picture']?>" class="img-thumbnail rounded-circle avatarSmall align-self-center">
                        <?php endif; ?>
                    </div>
                    <div class="col-md-10">
